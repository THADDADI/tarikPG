...
(0, CRUD_1.createDatabase)(databaseId, client)
  .then(() =>
    (0, CRUD_1.createContainer)(databaseId, containerId, "/id", client)
  )
...
const itemsFunctions = (req, context) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (req.method === "GET" && req.params.id) {
      ...
      try {
        ...
        const { resources } = yield (0, CRUD_1.getById)(
          databaseId,
          containerId,
          client,
          itemId
      ...
      //return all items
      try {
        const { resources } = yield (0, CRUD_1.getAll)(
          databaseId,
          containerId,
          client
        );
      ...
      try {
        ...
        const { resource: createdItem } = yield (0, CRUD_1.createItem)(
          databaseId,
          containerId,
          client,
          newItem
      ...
      try {
        ...
        const { resource: replacedItem } = yield (0, CRUD_1.updateItem)(
          databaseId,
          containerId,
          client,
          updatedItem,
      ...
      try {
        const itemId = req.params.id;
        const { resource: deletedItem } = yield (0, CRUD_1.deleteItem)(
          databaseId,
          containerId,
          client,
          itemId
